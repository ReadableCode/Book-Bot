...
def load_db_authors(authors_text_file_path, max_rows_to_read=None):
    row_counter = 0
...
def load_db_works(works_text_file_path, max_rows_to_read=None):
    row_counter = 0
    # read the first few lines of the text file
...
if __name__ == "__main__":
    ...
    works_by_author_df = get_books_for_author_id(conn, author_id)
...
if __name__ == "__main__":
    ...
    get_authors_for_book_id(conn, work_id)
